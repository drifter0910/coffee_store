    ...
    <div className="footer">
      <div className="wrapper">
        <div className="row">
          ...
          <div className="col-xl-3 lg-3 col-md-6">
            ...
            <div className="footer-content2">
              <div className="footer-content-item1">EXPAND YOUR MIND, CHANGE EVERYTHING</div>
            ...
            <div className="footer-content2">
              <div className="footer-content-item1">ELEVATE YOUR EXPECTATIONS</div>
              <div className="footer-content-time2">5.06.2022</div>
              <div className="space-footer w-100" />
            </div>
          </div>
        ...
        <div className="footer-license">
          <div className="row">
            <div className="license-l col-xl-3 col-md-3 col-sm-3">© CanhLam</div>
            ...
            <div className="license-r col-xl-3 col-md-4 col-sm-4">2022 All Rights Reserved</div>
          </div>
        </div>
      </div>
    </div>
