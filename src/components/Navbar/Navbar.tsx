...
import { faCartShopping, faSearch, faClose, faBars } from '@fortawesome/free-solid-svg-icons';
...
const Home: FC<Props> = ({ products, cart, removeFromCart }) => {
  ...
  const total = useMemo(() => {
    let price = 0;
    cart.forEach((item: { price: number; qty: number }) => {
  ...
  var menumask = <div className="menu-mask" onClick={() => setShowmenu(false)} />;
  return (
    <div className={navbar ? 'navbar active' : 'navbar '} id="Navbar">
      ...
      <div className="n-left">
        ...
        <div className="n-left-wrapper">
          <div className="search-mobile">
            <FontAwesomeIcon onClick={handleSearch} className="icon" icon={faSearch} />
            <input
          ...
          <div className="menuMobile">
            <div className={showmenu ? 'menu-nav active' : 'menu-nav'}>
              <ul>
                <Link to="/">
                  <li>Home</li>
                </Link>
      ...
      <div className="n-right">
        <ul className="n-right-list">
          ...
          <li>
            <NavLink style={({ isActive }) => (isActive ? activeStyle : nonActiveStyle)} to="blog">
              Blog
            </NavLink>
          </li>

          <li>
            <NavLink style={({ isActive }) => (isActive ? activeStyle : nonActiveStyle)} to="shop">
              Shop
            </NavLink>
          </li>
