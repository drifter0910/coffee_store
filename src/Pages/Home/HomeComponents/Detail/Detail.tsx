...
const getOk = document.getElementsByClassName('ok');
window.addEventListener('scroll', () => {
  for (let index = 0; index < getOk.length; index++) {
    var windowHeight = window.innerHeight;
    var revealTop = getOk[index].getBoundingClientRect().top;
    const revealPoint = -50;
    if (revealTop < windowHeight - revealPoint) {
      getOk[index].classList.add('reveal');
    } else {
      getOk[index].classList.remove('reveal');
    }
  }
});
        ...
        <div className="wrap-l">
          <div className="ok">
            <div className="detail-body-l ">
              ...
              <div className="hihi">
                Alienum phaedrum torquatos nec eu, vis detraxit periculis ex, nihil expetelis in
                mei. Meianpe icula euripidis,partem.
              </div>
            </div>
            <div className="hoho">
              <img src={detail1} alt="" />
